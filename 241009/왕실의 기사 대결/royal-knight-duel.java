...
/*
현재 기사에 대해 다음 기사를 탐색
자신음 포함한 이동하는 기사들을 리스트에 넣음
이동하는 기사가 벽을 만난다면 리스트는 초기화 후 끝
이동하는 기사가 이동을 한다면 리스트 추가후 끝 이제 뒤에서부터 이동
이동하는 기사가 기사를 만난다면 리스트에 추가
 */
